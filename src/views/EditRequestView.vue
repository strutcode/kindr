    ...
    <div v-else-if="request" class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
      ...
      <form @submit.prevent="handleSubmit" class="space-y-8">
        ...
        <div class="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              class="input"
              :class="{
                'border-error-300 focus:border-error-500 focus:ring-error-500': errors.title,
              }"
          ...
          <div>
            ...
            <textarea
              ...
              class="input"
              :class="{
                'border-error-300 focus:border-error-500 focus:ring-error-500': errors.description,
              }"
          ...
          <div class="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <select
                ...
                class="input"
                :class="{
                  'border-error-300 focus:border-error-500 focus:ring-error-500': errors.category,
                }"
        ...
        <div class="space-y-6">
          ...
          <div>
            <p class="text-sm text-gray-600 mb-4">
              Add or update images to help others understand your request better. You can upload up
              to 8 images.
            </p>
        ...
        <div class="flex items-center justify-between pt-6 border-t border-gray-200">
          <router-link :to="`/requests/${request.id}`" class="btn btn-outline">
            Cancel
          </router-link>
