<template>
  ...
  >
    ...
    >
      <!-- Header - Fixed -->
      <div class="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 bg-gray-50 flex-shrink-0">
        <div class="flex-1 min-w-0">
          ...
          <p class="text-xs text-gray-600 mt-1 sm:hidden">
      ...
      <div class="flex-1 overflow-y-auto">
        ...
        <div v-if="selectedLocation" class="p-3 sm:p-4 bg-blue-50 border-b border-blue-200 flex-shrink-0">
          <div class="flex items-start justify-between">
            <div class="flex items-start flex-1 min-w-0">
              <MapPinIcon class="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 mt-0.5 mr-2 sm:mr-3 flex-shrink-0" />
              <div class="flex-1 min-w-0">
        ...
        <div class="relative">
          ...
          >
            <div class="flex items-start">
              <InformationCircleIcon class="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 mr-2 flex-shrink-0 mt-0.5" />
              <p class="text-xs sm:text-sm text-gray-700">
                <span class="hidden sm:inline">Click anywhere on the map to select a location for browsing requests</span>
      ...
      <div class="flex items-center justify-between p-3 sm:p-6 border-t border-gray-200 bg-gray-50 flex-shrink-0">
        ...
        <div class="flex space-x-2 sm:space-x-3">
          <button
            @click="close"
            class="btn btn-outline btn-sm sm:btn-base"
          >
            Cancel
          </button>
          <button
