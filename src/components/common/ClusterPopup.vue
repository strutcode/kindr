      ...
      >
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50">
          <div class="flex items-center space-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600">Click any request to view details</p>
            </div>
          </div>
              ...
              <div class="flex items-start justify-between">
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center space-x-2 mb-2">
                    ...
                    <span
                      class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-primary-100 text-primary-800 flex-shrink-0"
                    >
                ...
                <div class="ml-4 flex-shrink-0">
                  <button @click.stop="handleRequestClick(request)" class="btn btn-outline btn-sm">
                    View
                  </button>
                </div>
              </div>
        ...
        <div class="p-4 border-t border-gray-200 bg-gray-50">
          <div class="flex items-center justify-between">
            <button @click="zoomToFit" class="btn btn-outline btn-sm">
...
<script setup lang="ts">
  ...
  // Computed properties
  const clusterColor = computed(() => MapClusteringService.getClusterColor(props.requests.length))
  ...
  const { getCategoryLabel, formatRelativeTime } = useRequestFormatting()
