      ...
      <div class="space-y-6">
        ...
        <div class="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              required
              class="input"
              :class="{ 'border-error-300 focus:border-error-500 focus:ring-error-500': errors.full_name }"
        ...
        <div>
          ...
          <input
            ...
            :class="{ 'border-error-300 focus:border-error-500 focus:ring-error-500': errors.phone }"
