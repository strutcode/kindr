  ...
  <div class="request-list">
    ...
    >
      ...
      <slot name="empty-action">
        <router-link v-if="showCreateButton" to="/requests/create" class="btn btn-primary">
      ...
      >
        ...
        <div v-if="variant === 'map'" class="p-4">
          <div class="flex items-start justify-between mb-2">
            ...
            <span
              class="inline-flex items-center justify-center w-6 h-6 bg-primary-600 text-white text-xs font-bold rounded-full ml-2 flex-shrink-0"
            >
              {{ index + 1 }}
            </span>
          </div>
